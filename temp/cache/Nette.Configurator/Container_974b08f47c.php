<?php
// source: /srv/www/beachturnaje/app/config/config.neon 
// source: /srv/www/beachturnaje/app/config/config.local.neon 

class Container_974b08f47c extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/srv/www/beachturnaje/app',
			'wwwDir' => '/srv/www/beachturnaje/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/srv/www/beachturnaje/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/srv/www/beachturnaje/app'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/srv/www/beachturnaje/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/srv/www/beachturnaje/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=beachturnaje', 'root', NULL, array('lazy' => TRUE));
	...
	{
		return new Container_974b08f47c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/srv/www/beachturnaje/app/../temp/cache/latte');
...
final class Container_974b08f47c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
